 ...
 * @author sronly
 */
public class consultarCategorias extends AbstractPageBean {
    ...
    private ObjectListDataProvider objectListDataProvider3 = new ObjectListDataProvider();

    public ObjectListDataProvider getObjectListDataProvider3() {
        return objectListDataProvider3;
    }

    public void setObjectListDataProvider3(ObjectListDataProvider oldp) {
        this.objectListDataProvider3 = oldp;
    }
    ...
    private ObjectListDataProvider objectListDataProvider4 = new ObjectListDataProvider();

    public ObjectListDataProvider getObjectListDataProvider4() {
        return objectListDataProvider4;
    }

    public void setObjectListDataProvider4(ObjectListDataProvider oldp) {
        this.objectListDataProvider4 = oldp;
    }
    private ObjectListDataProvider objectListDataProvider5 = new ObjectListDataProvider();

    public ObjectListDataProvider getObjectListDataProvider5() {
        return objectListDataProvider5;
    }

    public void setObjectListDataProvider5(ObjectListDataProvider oldp) {
        this.objectListDataProvider5 = oldp;
    }
    ...
    private Button buttonProcurarProduto1 = new Button();

    public Button getButtonProcurarProduto1() {
        return buttonProcurarProduto1;
    }

    public void setButtonProcurarProduto1(Button b) {
        this.buttonProcurarProduto1 = b;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("consultarCategorias Initialization Failure", e);
    ...
    public String buttonProcurarProduto_action() {
