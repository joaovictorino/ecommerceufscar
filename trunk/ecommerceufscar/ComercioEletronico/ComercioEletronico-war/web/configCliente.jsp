                ...
                <webuijsf:body binding="#{configCliente.body1}" id="body1" style="-rave-layout: grid">
                    <webuijsf:form binding="#{configCliente.form1}" id="form1">
                        ...
                        <webuijsf:hyperlink binding="#{configCliente.hyperlink1}" id="hyperlink1"
                            style="left: 336px; top: 336px; position: absolute; text-decoration: none" styleClass="outrosSmallText" text="Editar meus dados" url="/faces/editarDadosCliente.jsp"/>
                        <webuijsf:hyperlink binding="#{configCliente.hyperlink2}" id="hyperlink2"
                            style="left: 480px; top: 336px; position: absolute; text-decoration: none" styleClass="outrosSmallText" text="Incluir endereço" url="/faces/incluirEnderecoCliente.jsp"/>
                        <webuijsf:label binding="#{configCliente.label1}" id="label1" style="left: 336px; top: 480px; position: absolute"
                            styleClass="outrosSmallText" text="e-mail principal:"/>
                        <webuijsf:label binding="#{configCliente.label3}" id="label3" style="left: 576px; top: 768px; position: absolute"
                            styleClass="outrosSmallText" text="Ramal:"/>
                        <webuijsf:label binding="#{configCliente.label4}" id="label4"
                            style="color: rgb(0, 0, 51); font-size: 20px; font-style: normal; font-weight: lighter; left: 336px; top: 384px; position: absolute; text-decoration: none"
                            styleClass="titulo01" text="Informações obrigatórias para se cadastrar"/>
                        <webuijsf:label binding="#{configCliente.label5}" id="label5" style="left: 696px; top: 480px; position: absolute"
                            styleClass="outrosSmallText" text="data de nascimentos:"/>
                        <webuijsf:label binding="#{configCliente.label6}" id="label6" style="left: 336px; top: 864px; position: absolute"
                            styleClass="outrosSmallText" text="Celular:"/>
                        <webuijsf:label binding="#{configCliente.label7}" id="label7" style="left: 336px; top: 432px; position: absolute"
                            styleClass="outrosSmallText" text="Login:"/>
                        <webuijsf:label binding="#{configCliente.label9}" id="label9" style="left: 480px; top: 864px; position: absolute"
                            styleClass="outrosSmallText" text="DDD:"/>
                        <webuijsf:label binding="#{configCliente.label10}" id="label10" style="left: 576px; top: 816px; position: absolute"
                            styleClass="outrosSmallText" text="Ramal:"/>
                        <webuijsf:label binding="#{configCliente.label11}" id="label11"
                            style="color: rgb(0, 0, 51); font-size: 20px; font-style: normal; font-weight: lighter; left: 336px; top: 600px; position: absolute"
                            styleClass="outros" text="Informações obrigatórias para efetuar compras"/>
                        <webuijsf:label binding="#{configCliente.label12}" id="label12" style="left: 336px; top: 768px; position: absolute"
                            styleClass="outrosSmallText" text="Telefone fixo 1:"/>
                        <webuijsf:label binding="#{configCliente.label16}" id="label16" style="left: 528px; top: 480px; position: absolute"
                            styleClass="outrosSmallText" text="e-mail secundário:"/>
                        <webuijsf:label binding="#{configCliente.label17}" id="label17" style="left: 480px; top: 816px; position: absolute"
                            styleClass="outrosSmallText" text="DDD:"/>
                        <webuijsf:label binding="#{configCliente.label19}" id="label19" style="left: 336px; top: 648px; position: absolute"
                            styleClass="outrosSmallText" text="Nome completo:"/>
                        <webuijsf:label binding="#{configCliente.label23}" id="label23" style="left: 360px; top: 552px; position: absolute"
                            styleClass="outrosSmallText" text="       Desejo receber informações de produtos do meu interesse!"/>
                        <webuijsf:label binding="#{configCliente.label24}" id="label24" style="left: 336px; top: 816px; position: absolute"
                            styleClass="outrosSmallText" text="Telefone fixo 2:"/>
                        <webuijsf:label binding="#{configCliente.label25}" id="label25"
                            style="color: rgb(0, 0, 51); font-size: 16px; font-style: normal; font-weight: normal; left: 336px; top: 720px; position: absolute"
                            styleClass="outros" text="Telefones"/>
                        <webuijsf:label binding="#{configCliente.label26}" id="label26" style="left: 528px; top: 648px; position: absolute"
                            styleClass="outrosSmallText" text="C.P.F.:"/>
                        <webuijsf:checkbox binding="#{configCliente.checkbox1}" id="checkbox1" readOnly="true"
                            style="color: rgb(0, 0, 153); left: 336px; top: 552px; position: absolute" styleClass="outrosSmallText"/>
                        <webuijsf:label binding="#{configCliente.label28}" id="label28" style="left: 480px; top: 768px; position: absolute"
                            styleClass="outrosSmallText" text="DDD:"/>
                        <webuijsf:label binding="#{configCliente.dataNascimento}" id="dataNascimento" style="left: 696px; top: 504px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.dataNasc}"/>
                        <webuijsf:label binding="#{configCliente.login}" id="login"
                            style="color: rgb(0, 51, 204); font-family: 'Comic Sans MS','Arial','Helvetica',sans-serif; font-style: normal; font-weight: lighter; left: 336px; top: 456px; position: absolute" text="#{configCliente.cliente.loginPes}"/>
                        <webuijsf:label binding="#{configCliente.emailPrincipal}" id="emailPrincipal" style="left: 336px; top: 504px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.email}"/>
                        <webuijsf:label binding="#{configCliente.nomeCompleto}" id="nomeCompleto" style="left: 336px; top: 672px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.nome}"/>
                        <webuijsf:label binding="#{configCliente.emailSecundario}" id="emailSecundario" style="left: 528px; top: 504px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.email}"/>
                        <webuijsf:label binding="#{configCliente.cpf}" id="cpf" style="left: 528px; top: 672px; position: absolute" styleClass="textoUsuario" text="#{configCliente.cliente.cpf}"/>
                        <webuijsf:label binding="#{configCliente.telFixo1}" id="telFixo1" style="left: 336px; top: 792px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.telefone}"/>
                        <webuijsf:label binding="#{configCliente.dddFixo1}" id="dddFixo1" style="left: 480px; top: 792px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.dddtelefone}"/>
                        <webuijsf:label binding="#{configCliente.ramalFixo1}" id="ramalFixo1" style="left: 576px; top: 792px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.ramal}"/>
                        <webuijsf:label binding="#{configCliente.ramalFixo2}" id="ramalFixo2" style="left: 576px; top: 840px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.ramal}"/>
                        <webuijsf:label binding="#{configCliente.dddFixo2}" id="dddFixo2" style="left: 480px; top: 840px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.dddtelefone}"/>
                        <webuijsf:label binding="#{configCliente.telFixo2}" id="telFixo2" style="left: 336px; top: 840px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.telefone}"/>
                        <webuijsf:label binding="#{configCliente.celular}" id="celular" style="left: 336px; top: 888px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.celular}"/>
                        <webuijsf:label binding="#{configCliente.dddCelular}" id="dddCelular" style="left: 480px; top: 888px; position: absolute"
                            styleClass="textoUsuario" text="#{configCliente.cliente.dddcelular}"/>
                        <webuijsf:label binding="#{configCliente.label2}" id="label2"
                            style="color: rgb(0, 0, 51); font-size: 16px; font-style: normal; font-weight: normal; left: 336px; top: 936px; position: absolute"
                            styleClass="outros" text="Endereços"/>
                        <webuijsf:table augmentTitle="false" binding="#{configCliente.tabEnderecos}" id="tabEnderecos"
                            style="color: rgb(0, 0, 102); font-size: 12px; font-style: normal; font-weight: lighter; left: 336px; top: 984px; position: absolute; text-decoration: none; width: 840px"
                        ...
                        <webuijsf:hyperlink binding="#{configCliente.hyperlink3}" id="hyperlink3"
                            style="left: 624px; top: 336px; position: absolute; text-decoration: none" styleClass="outrosSmallText" text="Alterar Senha" url="/faces/alterarSenhaCliente.jsp"/>
                    </webuijsf:form>
                </webuijsf:body>
            </webuijsf:html>
        </webuijsf:page>
