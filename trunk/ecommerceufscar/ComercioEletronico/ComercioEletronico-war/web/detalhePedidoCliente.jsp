                ...
                <webuijsf:body binding="#{detalhePedidoCliente.body1}" id="body1" style="-rave-layout: grid">
                    <webuijsf:form binding="#{detalhePedidoCliente.form1}" id="form1">
                        ...
                        <webuijsf:label binding="#{detalhePedidoCliente.label1}" id="label1"
                            style="color: rgb(0, 0, 51); font-size: 20px; font-style: normal; font-weight: lighter; left: 336px; top: 312px; position: absolute; text-decoration: none"
                            styleClass="titulo01" text="Detalhe do meu pedido:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label2}" id="label2"
                            style="font-weight: normal; left: 528px; top: 360px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.pedido.formaPagamento}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label3}" id="label3"
                            style="font-weight: normal; left: 720px; top: 432px; position: absolute" styleClass="outrosSmallText" text="Valor total:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label4}" converter="#{configComprasCliente.carrinhoProdutos.realConverter1}" id="label4"
                            style="font-weight: normal; left: 888px; top: 432px; position: absolute" styleClass="textoUsuario" text="#{configComprasCliente.ultimaCompra.valorTotal}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label5}" id="label5"
                            style="font-weight: normal; left: 336px; top: 384px; position: absolute" styleClass="outrosSmallText" text="Data do pedido:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label6}" id="label6"
                            style="font-weight: normal; left: 528px; top: 384px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.pedido.dataPedido}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label7}" id="label7"
                            style="font-weight: normal; left: 336px; top: 360px; position: absolute" styleClass="outrosSmallText" text="Forma de pagamento:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label8}" id="label8"
                            style="color: rgb(0, 0, 51); font-size: 20px; font-style: normal; font-weight: lighter; left: 576px; top: 312px; position: absolute; text-decoration: none"
                        ...
                        <webuijsf:label binding="#{detalhePedidoCliente.label9}" id="label9"
                            style="font-weight: normal; left: 336px; top: 408px; position: absolute" styleClass="outrosSmallText" text="Data Prevista para a entrega:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label10}" id="label10"
                            style="font-weight: normal; left: 528px; top: 408px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.pedido.dataPrevistaEntrega}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label11}" id="label11"
                            style="font-weight: normal; left: 336px; top: 432px; position: absolute" styleClass="outrosSmallText" text="Data da entrega:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label12}" id="label12"
                            style="font-weight: normal; left: 528px; top: 432px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.pedido.dataEntrega}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label13}" id="label13"
                            style="font-weight: normal; left: 888px; top: 360px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.pedido.statusCompra}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label14}" id="label14"
                            style="font-weight: normal; left: 720px; top: 360px; position: absolute" styleClass="outrosSmallText" text="Status do pedido:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label15}" id="label15"
                            style="font-weight: normal; left: 336px; top: 552px; position: absolute" styleClass="outrosSmallText" text="Endereço de entrega:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label17}" id="label17"
                            style="font-weight: normal; left: 720px; top: 384px; position: absolute" styleClass="outrosSmallText" text="Valor do frete:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label18}" id="label18"
                            style="font-weight: normal; left: 720px; top: 408px; position: absolute" styleClass="outrosSmallText" text="Desconto concedido:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label19}" id="label19"
                            style="font-weight: normal; left: 336px; top: 504px; position: absolute" styleClass="outrosSmallText" text="Observações:"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label20}" id="label20"
                            style="font-weight: normal; left: 480px; top: 552px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.stgEndereco}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label22}" id="label22"
                            style="font-weight: normal; left: 888px; top: 384px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.pedido.valorFrete}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label23}" id="label23"
                            style="font-weight: normal; left: 888px; top: 408px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.pedido.desconto}"/>
                        <webuijsf:label binding="#{detalhePedidoCliente.label24}" id="label24"
                            style="font-weight: normal; left: 480px; top: 504px; position: absolute" styleClass="textoUsuario" text="#{detalhePedidoCliente.pedido.observacoes}"/>
                        <webuijsf:table augmentTitle="false" binding="#{detalhePedidoCliente.table1}" id="table1"
                            style="left: 336px; top: 600px; position: absolute; width: 624px" title="Itens do Pedido" width="624">
