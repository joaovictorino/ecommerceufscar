 ...
 *
 * Created on 01/05/2008, 15:53:40
 */
 ...
 */
public class carrinhoDeCompras extends AbstractPageBean {
    @EJB
    ...
    public void setBtnComprar(Button b) {
        this.btnComprar = b;
    }
    ...
    public void setProdutos(List<Produtos> p) {
        this.produtos = p;
    }  */
    ...
    public void setBtnRemover(Button b) {
        this.btnRemover = b;
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("CarrinhoDeCompras Initialization Failure", e);
    ...
    /*public void carregarCarrinhoDeCompras()
    {
        ...
        this.setProdutos(produtoBean.listaProdutosPorId(ids));
        for(Produtos p : this.getProdutos()){
            p.setQtdeCompras(carrinho.get(p.getCodProduto()));
        }
    }
