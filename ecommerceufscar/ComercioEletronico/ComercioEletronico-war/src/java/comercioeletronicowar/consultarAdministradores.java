 ...
 * @author sronly
 */
public class consultarAdministradores extends AbstractPageBean {
     ...
     */
    public consultarAdministradores() {
    }
    ...
    public void init() {
        ...
        try {
            ...
            log("consultarAdministradores Initialization Failure", e);
